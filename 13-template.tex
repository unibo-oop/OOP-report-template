...
\begin{itemize}
	...
	\item Should meet minimal security requirements for user recognition.
	\item Should be smart enough to consistenly manage the whole house-system.  
\end{itemize}
...
The main difficulty will be implementing a communication protocol for the controller and the devices, which can vary in functioning and technical aspects. 
