...
\chapter{Analisi}
L'obiettivo e realizzare un sistema domotico intelligente simulateo che permetta la gestione 
di sensori e impianti in un ambiente domestico.
Homer e un controllo domotico che permette la gestione di sensori domotici intelligenti, in particolare 
permette all'utente di settare.
% TODO Insert stuff
...
\section{Requisiti}
L' applicazione dovra peremttere all' utente di gestire il proprio ambiente domotico. 
...
\begin{itemize}
Dato che homer e un home assistant dovra avere le seguenti funzionalita:
...
...
\begin{itemize}
	\item app semplice  da utilizzare per qualsiasi utenti
	\item Processing dei dati deve essere efficiente 
...
L' applicazione e un controller domotico, che simulera dei dispositivi che possono essere controllati da una dashboard
...
\chapter{Design}
Abbiamo usato MVC dato che mappa perfettamente al nostro use case, in cui avremo una view,un  
controller che fa update allo stato, e dei model che lo mantengono.
