...
\begin{itemize}
	\item View 
	\item Various kinds of devices
	\item Should be resonably performant
\end{itemize}
...
\begin{itemize}
Since homer is a home assistant it should have these functionalities: 
... (copy from the word document)
