...
\chapter{Analysis}
The goal of the project is creating a (simulated)j intelligent domotic system that allows users 
to control devices in their home.

\section{Requirements}
\subsubsection{Functional Requirements}

\begin{itemize}
	\item light and electrical outlets should be controllable
	\item Doors, locks and windows should be controllable
	\item Temperature electricity, and air control monitoring
	\item Temperature, electricity and air quality graphs
	\item Logger
	\item Managing components dasbhoard  
\end{itemize}

\subsubsection{Nonfunctional Requirements}
\begin{itemize}
	\item Should be reasonably performant
\end{itemize}


\section{Analisi e modello del dominio}

The application is a domotic controller, and it will emulate devices that can be controlled by a dashboard.
