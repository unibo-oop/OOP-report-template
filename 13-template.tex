...
The goal of the software HOMER (HOMe EmulatoR) is to emulate a domotic controller connected to lights, windows, and other domestic devices.
The software will provide a dashboard to the user to allow control of the devices and monitoring of sensors and consumptions.
...
The application will emulate a domotic controller connected to home devices.
The home devices will also be emulated, each with its own logic.
The user will be able to interact with the devices via the controller with a dashboard.

The main difficulty will be modelling the communication between the controller and the different devices, which can vary in functioning.
